...
const Carts = () => {
    ...
    <Card style={{ width: '18rem' }} >
        ...
        <Card.Body className='card-body'>
          <Card.Title className='title fw-bold'>Parker solar probe overview.</Card.Title>
        ...
        <Card.Body>
          <Card.Title className='title fw-bold'>Why won’t Parker's probe melt?
</Card.Title>
          <Card.Text className='text'>
      ...
      <Card style={{ width: '18rem' }}>
        ...
        <Card.Body>
          <Card.Title className='title fw-bold'>5 weird things happened in space
</Card.Title>
          <Card.Text className='text'>
          </Card.Text>
